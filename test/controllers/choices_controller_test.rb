...
class ChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post choices_url, params: { choice: { choice: @choice.choice, number: @choice.number, question_id: @choice.question_id } }
    end
  ...
  test "should update choice" do
    patch choice_url(@choice), params: { choice: { choice: @choice.choice, number: @choice.number, question_id: @choice.question_id } }
