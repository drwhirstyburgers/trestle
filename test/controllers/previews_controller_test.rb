...
class PreviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create preview" do
    assert_difference('Preview.count') do
      post previews_url, params: { preview: { blurb: @preview.blurb, course_id: @preview.course_id } }
    end
  ...
  test "should update preview" do
    patch preview_url(@preview), params: { preview: { blurb: @preview.blurb, course_id: @preview.course_id } }
