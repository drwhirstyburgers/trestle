                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-group list-group-flush" v-for="course in allCourses" v-bind:course="course" v-bind:key="course.key">
                                    <li class="list-group-item">
                                        ...
                                        <i data-toggle="tooltip" data-placement="right" title="Click to make this your active course" v-on:click="makeActiveCourse(course)" class="material-icons float-right" id="activeStar" v-bind:style="isItActive(course)">star</i>
                                    </li>
                                </ul>
                            </div>
                        </div>
